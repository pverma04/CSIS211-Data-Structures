...
public class SearchTree<T extends Comparable<T>> {
    ...
    private Node findMinNode(Node n) {
        if (n.left == null) { //nothing to the left/smaller, return this node
            ...
            return this.findMinNode(n.left); //keep reccuring to the left for min value
        }
    }
    ...
    private Node findMaxNode(Node n) {
        if (n.right == null) { //nothing to the right/bigger, return this node
            ...
            return this.findMaxNode(n.right); //keep reccuring to the right for max value
        }
    }
    ...
    private Node remove(T data, Node n) {
        ...
        if (data.compareTo((T) n.data) < 0) { //going to the left
            ...
            n.data = (T) findMinNode(n.right).data;
