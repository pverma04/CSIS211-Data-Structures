...
public class LinkedList<T> {
    ...
    public void addToEnd(T data) {
        ...
        if (this.mHead == null) { //this means the list contains nothing
            this.mHead = nodeAdd; //head now hold the data which has been added
            this.mHead.mNext = null;
            this.mTail = this.mHead;
        } else {
            this.mTail.mNext = nodeAdd;
            nodeAdd.mOffset = this.mTail.mOffset + 1;
            this.mTail = nodeAdd;
        }
    }
    ...
    public void addToFirst(T data) {
        ...
        if (this.mHead == null) {
            ...
            Node p = this.mHead; //reference node
            while (p.mNext != null) {
                p = p.mNext;
                p.mOffset++;
            }
    ...
    public void insert(T search, T data) {
        ...
        Node h = toSearch; //reference node
        int offsetCount = h.mOffset;
        while (h.mNext != null) {
            h = h.mNext;
            h.mOffset = offsetCount++;
            offsetCount++;
        }
    }
     ...
     * ***********************************************
     * @par Name getNode
     * @purpose Returns the the Node that contains the given 'search' in its
     * data
     * @param [in] : T search
     * @return Node
     * @par References None
