...
public class PairList<T> extends LinkedList<Pair> {
     ...
     * ***********************************************
     * @par Name insert
     * @purpose Create and insert a new pair following the node containing the
     * search pair
     ...
     * ***********************************************
     * @par Name insert
     * @purpose Insert a new pair following the node containing the search pair
     ...
     * ***********************************************
     * @par Name insert
     * @purpose Insert a new pair at the index of the linked list moving
     ...
     * ***********************************************
     * @par Name insert
     * @purpose Create and insert a new pair at the index of the linked list
     ...
     * ***********************************************
     * @par Name getSecond
     * @purpose Find and return the 'second' value of a pair by searching for
     * the Node with data containing the given 'first' value
     * @param [in] : T first
     * @return T
     * @par References None
     * @par Notes None ***********************************************
